    ...
    protected function extendLocationOptionsFields()
    {
        ...
        Event::listen('system.formRequest.extendValidator', function ($formRequest, $dataHolder) {
            ...
            $dataHolder->attributes = array_merge($dataHolder->attributes, [
                ...
                'options.min_reservation_guest_num' => lang('igniter.reservation::default.label_min_reservation_guest_num'),
                'options.max_reservation_guest_num' => lang('igniter.reservation::default.label_max_reservation_guest_num'),
            ...
            $dataHolder->rules = array_merge($dataHolder->rules, [
                ...
                'options.min_reservation_guest_num' => ['integer', 'min:0', 'max:999'],
                'options.max_reservation_guest_num' => ['integer', 'min:0', 'max:999'],
